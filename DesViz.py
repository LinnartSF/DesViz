...
class DesVizObject:
    ...
    slaves    :list      #list of sprites which are slaves to this sprite
    master    :object #slave's reference to the master sprite
    master_dx :float  #this relates to a slave, gives the offset between master and slave origin points
    master_dy :float
    ...
    def place(self, 
        ...
        """ imediately position object at position x1, y1 """    
    ...
    def rotate(self, 
        ...
        """ imediately rotate sprite around guide point """
    ...
    def move(self, 
        ...
        """ initiate move at time t0 from current location to x1, y1 with move simulation time duration t and timestep dt """    
    ...
    def move_on_path(self, 
        ...
        t               :float, 
        auto_orient     :int, 
        start_current   :bool = False, 
        end             :int = 1
        )               -> None:
        
        """ moves a sprite along a predefined path"""
    ...
    def place_on_path(self, 
        path        :object, 
        auto_orient :str, 
        end         :int = 0
        )           -> None:
        
        """ places sprite guide point onto path """
    ...
    def attach_to(self, 
        ...
        This attaches one sprite (slave) to another (master), at relative position according to specified offset between the sprite origin points. 
        Both sprites will have the same rotation when being moved together.
    ...
    def detach(self) -> None:
        ...
        """ This reverses the effect of the attach instruction """
    ...
    def calc_guide_offset(self) -> tuple:

        """ calculates relevant guide offset of sprite, returns as (float, float) for x and y axis """
    ...
    def update_slaves(self) -> None:
        ...
        """ updates rotation, position, and scale of all attached slaves """
...
class DesVizPath:
    ...
    def add_waypoint(self, 
        ...
        """ used for adding waypoint and append it to the paths list of waypoints """
...
class DesVizProgressBar:
    ...
    DesViz provides the ability to display and update progress bars throughout the course of the animation. 
    The progress bars can be statically located on the animation canvas or can be attached to sprites.
    ...
    def __init__(self, 
        ...
        Hy       :float, 
        rotation :float, 
        color    :tuple, # tuple with 4 elements, type INT 
        batch    :pyglet.graphics.Batch, 
        group    :pyglet.graphics.Group
        ):
    ...
    def update_position(self, 
        ...
        """ updates and changes progress bar position and rotation, TODO """
    ...
    def attach_to_object(self, 
        ...
        Sets master sprite for progress bar
    ...
    def update_attached_position(self) -> None:
        """ """
...
class DesVizMaster:
    ...
    Class which contains and provides access to DesViz functionality. 
    There should only be one object instantiated from this class.
    ...
    batch               :pyglet.graphics.Batch
    background          :pyglet.graphics.Group
    foreground          :pyglet.graphics.Group
    images              :dict
    all_obj             :dict
    fore_obj            :dict      #subset of all_obj including all foreground objects
    labels              :dict
    x_min               :int
    x_scale             :float
    y_min               :int
    y_scale             :float
    sim_unit_per_second :float
    elapsed             :float
    ...
    def set_anim_speed(self, 
        ...
        Sets playback speed of the animation, if required. 
        If not specified the default play-back speed is 1 unit of simulation time per second.
    ...
    def set_script(self, 
        ...
        """ Provides a filename for reading the animation csv file """
    ...
    def set_paths(self, 
        ...
        """ Provides a filename for reading the movement paths table if required """
    ...
    def run(self, 
        ...
        """ Starts the animation application and the frame is redrawn every frame interval seconds """
        
        pyglet.clock.schedule_interval(self.frame_update, frame_interval)
        pyglet.app.run()

    # TODO
    def update_animation_actions(self) -> None:
